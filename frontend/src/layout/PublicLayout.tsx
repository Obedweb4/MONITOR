      ...
      <header className="fixed top-0 left-0 right-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-line rounded-b-2xl shadow-sm">
        <div className="main flex items-center justify-between h-14">
          <Link to="/" className="flex items-center gap-2 font-bold text-base font-outfit">
            <img
              src="https://files.obedtech.top/image/u2wvoimage.jpg"
              alt="OBEDTECH MONITOR"
              className="w-8 h-8 rounded-full object-cover shrink-0"
            />
            <span>
              <span className="text-emerald-500">OBED</span>{" "}
              <span>Monitor</span>
            </span>
          </Link>
            ...
            >
              ...
              <div className="flex items-center justify-between px-5 h-14 border-b border-line shrink-0">
                <Link to="/" onClick={() => setMobileOpen(false)} className="flex items-center gap-2 font-bold text-sm font-outfit">
                  ...
                  />
                  <span><span className="text-emerald-500">OBED</span>TECH MONITOR</span>
                </Link>
      ...
      <footer className="mx-4 mb-4 border border-line rounded-2xl">
        <div className="main py-3 flex flex-col sm:flex-row items-center justify-between gap-2 flex-wrap">
          ...
          <p className="text-xs text-muted text-center">
            ...
            <a href="https://me.obedtech.top" target="_blank" rel="noopener noreferrer" className="text-emerald-500 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors font-medium">OBED TECH</a>
            {" "}· All rights reserved.
          </p>
        </div>
      </footer>
