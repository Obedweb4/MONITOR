      ...
      <section className="pt-12 pb-10 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <h1 data-aos="zoom-in" className="text-4xl md:text-5xl font-bold font-outfit mb-4">
            About <span className="text-emerald-500">OBEDTECH MONITOR</span>
          </h1>
        ...
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <div data-aos="fade-right" data-aos-duration="600">
            ...
            <p className="text-muted leading-relaxed text-sm">
              OBEDTECH MONITOR is a product of{" "}
              <a href="https://obedtech.top" target="_blank" rel="noopener noreferrer" className="text-emerald-500 hover:underline font-medium">
                OBED TECH
              </a>{" "}
          ...
          <div data-aos="fade-left" data-aos-duration="600">
            ...
            <p className="text-muted leading-relaxed text-sm">
              That's the insight behind OBEDTECH MONITOR. We send clean, actionable email alerts the moment
      ...
      <section className="py-14 px-4 bg-secondary overflow-hidden">
        <div className="main">
          <div className="text-center mb-10">
            ...
            <p data-aos="fade-up" data-aos-delay="100" className="text-muted max-w-xl mx-auto text-sm">Our principles guide how we build and operate OBEDTECH MONITOR.</p>
          </div>
