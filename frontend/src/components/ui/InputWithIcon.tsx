    ...
    <div className="space-y-2">
      ...
      <div className="relative mt-1">
        ...
        <input
          ...
          className={`pl-12 h-11 w-full rounded-xl text-sm border border-line focus:border-main ${props.className ?? ""}`}
        />
        {type === "password" && (
          <div onClick={() => setShowPassword(p => !p)} className="absolute right-4 top-1/2 -translate-y-1/2 text-muted cursor-pointer">
