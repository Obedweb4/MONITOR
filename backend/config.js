...
module.exports = {
  ...
  JWT_SECRET: process.env.JWT_SECRET || "obedtech_monitor_jwt_secret_dev_only",
  ...
  RESEND1_DOMAIN:  process.env.RESEND1_DOMAIN  || "monitor-alerts.obedtech.top",
  RESEND2_API_KEY: process.env.RESEND2_API_KEY || "",
  RESEND2_DOMAIN:  process.env.RESEND2_DOMAIN  || "monitoring-alerts.obedtech.top",
  RESEND3_API_KEY: process.env.RESEND3_API_KEY || "",
  RESEND3_DOMAIN:  process.env.RESEND3_DOMAIN  || "monitoring-alert.obedtech.top",
  ...
  EMAIL_FROM_NAME: process.env.EMAIL_FROM_NAME || "OBEDTECH MONITOR",
  FRONTEND_URL: process.env.FRONTEND_URL || "https://monitor.obedtech.top",
